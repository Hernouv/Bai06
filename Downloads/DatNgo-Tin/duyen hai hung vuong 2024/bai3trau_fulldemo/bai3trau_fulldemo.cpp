...
/*
    Ý tưởng: Xử lý các truy vấn t = 2 trước, t = 1 sau hoặc ngược lại.

    Mọi truy vấn t = 2, tính bằng dp-tree.
    dp-tree: val[u] là độ tươi tốt của đỉnh u, mỗi truy vấn dạng 2 u k tăng val[u] lên k
    dfs từ đỉnh 1 để tính độ tươi tốt.

    Với truy vấn t = 1, sử dụng HLD để cập nhật đoạn trên cây.
    Khởi tạo Segment Tree quản lý giá trị các đỉnh, áp dụng HLD và kết quả thu được sau khi thực hiện truy vấn t = 2.
*/